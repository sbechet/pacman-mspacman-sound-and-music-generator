...
MusicsAndEffects = {
    ...
    effects: {
        ...
        //"test" :            [0, 24000,     0,   0, 0,     0,  0, 0,  8, 0],
    },

    // octave number 4 in real world
    octave: {
        "C-": 4*440/Math.pow(2,9/12),
        "C#": 4*440/Math.pow(2,8/12),
        "D-": 4*440/Math.pow(2,7/12), 
        "D#": 4*440/Math.pow(2,6/12), 
        "E-": 4*440/Math.pow(2,5/12),
        "F-": 4*440/Math.pow(2,4/12),
        "F#": 4*440/Math.pow(2,3/12),
        "G-": 4*440/Math.pow(2,2/12),
        "G#": 4*440/Math.pow(2,1/12),
        "A-": 4*440,
        "A#": 4*440*Math.pow(2,1/12),
        "B-": 4*440*Math.pow(2,2/12),
    },
